...
- [2023-01-23 (월)](#2023-01-23-월)
- [2023-01-22 (일)](#2023-01-22-일)
- [2023-01-20 (금)](#2023-01-20-금)
- [2023-01-19 (목)](#2023-01-19-목)
- [2023-01-18 (수)](#2023-01-18-수)
...
- [ ] [#15 Client 연결 보안 설정 및 P2P, Single 카테고리 선택 페이지 생성](https://github.com/jcggl/test_realtimeapi/issues/15)
...
- Redis 캐싱 디비 추가
- Preprocess - Postprocess 간 인증 시스템 구축
...
- [x] [#13 서버 Nginx 라우터 설정](https://github.com/jcggl/test_realtimeapi/issues/13)

<br>

> Todo List

- Ubuntu 내부 포트 - EC2 로드밸런서 연결
- Nginx 내부 포트포워딩 설정
- 배포 후 라이브 테스트
...
- [x] [#12 AWS EC2 서버 배포](https://github.com/jcggl/test_realtimeapi/issues/12)
